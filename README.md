...
❤️‍🔥 I love working with Python and Javascript and I have a strong passion for them. My main interests are in Software Development, Mobile Application Development and  Website & Web Applications Development. 

👨🏻‍💻 As a Software Engineer, I enjoy solving problems, making new applications and posing a big impact whenever I go. I would say that if I had a superpower, it would be problem solving. Currenlty, I am a Software Engineer at <b>Vitafluence.ai</b> were we create compassionate AI that solves specific important human health problems such as helping children with developmental disabilities such as Autism spectrum disorder (ASD).
